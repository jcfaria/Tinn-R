...
::Deleting no longer necessary file from binPortable
del   /q distribution\"Tinn-R Portable"\Tinn-R\App\binPortable\"Tinn_RPortable.exe.manifest"
...
xcopy /s package distribution\"Tinn-R Portable"\Tinn-R\App\package /e 

::Deleting one not necessary file from package
del   /q distribution\"Tinn-R Portable"\Tinn-R\App\package\readme.txt

xcopy /s project\"project.zip" distribution\"Tinn-R Portable"\Tinn-R\App\project /e 
xcopy /s res distribution\"Tinn-R Portable"\Tinn-R\App\res /e 
xcopy /s sample distribution\"Tinn-R Portable"\Tinn-R\App\sample /e 
xcopy /s sumatra distribution\"Tinn-R Portable"\Tinn-R\App\sumatra /e 
xcopy /s templates distribution\"Tinn-R Portable"\Tinn-R\App\templates /e 
xcopy /s utils distribution\"Tinn-R Portable"\Tinn-R\App\utils /e 
::End of file's copy
...
rename   Tinn-R\App\binPortable\Tinn-RPortable.exe.manifest "Tinn-R Portable.exe.manifest"
