...
const
  ...
  SYNS_AttrPrograming           =  'Programing';
...
resourcestring
  ...
  //-----------------------------------------------------
  // Specif to the project Tinn-R project: J.C.Faria
  SYNS_FriendlyAttrDatasets             =  'Datasets';
  SYNS_FriendlyAttrPrograming           =  'Programing';
  SYNS_FriendlyAttrPlotting             =  'Plotting';
  //-----------------------------------------------------
  ...
  SYNS_FilterPascal             =  'Pascal (*.pas;*.pp;*.dpr;*.dpk;*.inc)|*.pas;*.pp;*.dpr;*.dpk;*.inc';
  SYNS_FilterHP48               =  'HP48 (*.s;*.sou;*.a;*.hp)|*.s;*.sou;*.a;*.hp';
  SYNS_FilterCAClipper          =  'CA-Clipper (*.prg;*.ch;*.inc)|*.prg;*.ch;*.inc';
  SYNS_FilterCORBAIDL           =  'CORBA IDL (*.idl)|*.idl';
  SYNS_FilterCPM                =  'CPM (*.rdf;*.rif;*.rmf;*.rxf)|*.rdf;*.rif;*.rmf;*.rxf';
  SYNS_FilterCPP                =  'C/C++ (*.c;*.cpp;*.cc;*.h;*.hpp;*.hh;*.cxx;*.hxx;*.cu)|*.c;*.cpp;*.cc;*.h;*.hpp;*.hh;*.cxx;*.hxx;*.cu';
  SYNS_FilterCS                 =  'C# (*.cs)|*.cs';
  SYNS_FilterDWS                =  'DWScript (*.dws;*.pas;*.inc)|*.dws;*.pas;*.inc';
  SYNS_FilterJava               =  'Java (*.java)|*.java';
  SYNS_FilterPerl               =  'Perl (*.pl;*.pm;*.cgi)|*.pl;*.pm;*.cgi';
  SYNS_FilterAWK                =  'AWK (*.awk)|*.awk';
  SYNS_FilterHTML               =  'HTML (*.htm;*.html)|*.htm;*.html';
  SYNS_FilterVBScript           =  'VBScript (*.vbs)|*.vbs';
  SYNS_FilterGalaxy             =  'Galaxy (*.gtv;*.galrep;*.txt)|*.gtv;*.galrep;*.txt';
  SYNS_FilterPython             =  'Python (*.py)|*.py';
  SYNS_FilterSQL                =  'SQL (*.sql)|*.sql';
  SYNS_FilterTclTk              =  'TclTk (*.tcl)|*.tcl';
  SYNS_FilterRTF                =  'Rich Text Format (*.rtf)|*.rtf';
  SYNS_FilterBatch              =  'Batch MS-DOS (*.bat;*.cmd)|*.bat;*.cmd';
  SYNS_FilterDFM                =  'Borland Form (*.dfm;*.xfm)|*.dfm;*.xfm';
  SYNS_FilterX86Assembly        =  'Assembly x86 (*.asm)|*.asm';
  SYNS_FilterGembase            =  'GEMBASE (*.dml;*.gem)|*.dml;*.gem';
  SYNS_FilterINI                =  'INI (*.ini)|*.ini';
  SYNS_FilterSML                =  'Standard ML (*.sml)|*.sml';
  SYNS_FilterVisualBASIC        =  'Visual Basic (*.bas)|*.bas';
  SYNS_FilterADSP21xx           =  'DSP (*.dsp;*.inc)|*.dsp;*.inc';
  SYNS_FilterPHP                =  'PHP (*.php;*.php3;*.phtml;*.inc)|*.php;*.php3;*.phtml;*.inc';
  SYNS_FilterCache              =  'Cache (*.mac;*.inc;*.int)|*.mac;*.inc;*.int';
  SYNS_FilterCSS                =  'CSS (*.css)|*.css';
  SYNS_FilterJScript            =  'JavaScript (*.js)|*.js';
  SYNS_FilterKIX                =  'KiXtart (*.kix)|*.kix';
  SYNS_FilterBaan               =  'Baan 4GL (*.cln)|*.cln';
  SYNS_FilterFoxpro             =  'Foxpro (*.prg)|*.prg';
  SYNS_FilterFortran            =  'Fortran (*.for)|*.for';
  SYNS_FilterAsm68HC11          =  '68HC11 Assembler (*.hc11;*.asm;*.asc)|*.hc11;*.asm;*.asc';
  SYNS_FilterProgress           =  'Progress (*.w;*.p;*.i)|*.w;*.p;*.i';
  SYNS_FilterInno               =  'Inno Setup (*.iss)|*.iss';
  SYNS_FilterModelica           =  'Modelica (*.mo)|*.mo';
  SYNS_FilterModula3            =  'Modula-3 (*.m3)|*.m3';
  SYNS_FilterSDD                =  'Semanta DD (*.sdd)|*.sdd';
  SYNS_FilterXML                =  'XML (*.xml;*.xsd;*.xsl;*.xslt;*.dtd)|*.xml;*.xsd;*.xsl;*.xslt;*.dtd';
  SYNS_FilterGWS                =  'GW-TEL (*.gws)|*.gws';
  SYNS_FilterSynGenMsgfiles     =  'Msg (*.msg)|*.msg';
  SYNS_FilterST                 =  'Structured Text (*.st)|*.st';
  SYNS_FilterCOBOL              =  'COBOL (*.cbl;*.cob)|*.cbl;*.cob';
  SYNS_FilterTeX                =  'TeX (*.tex;*.sty)|*.tex;*.sty';
  SYNS_FilterRC                 =  'Resource (*.rc)|*.rc';
  SYNS_FilterRuby               =  'Ruby (*.rb;*.rbw)|*.rb;*.rbw';
  SYNS_FilterUNIXShellScript    =  'UNIX Shell (*.sh)|*.sh';
  SYNS_FilterHaskell            =  'Haskell (*.hs;*.lhs)|*.hs;*.lhs';
  SYNS_FilterDOT                =  'DOT Graph Drawing Description (*.dot)|*.dot';
  SYNS_FilterEiffel             =  'Eiffel (*.e;*.ace)|*.e;*.ace';
  SYNS_FilterLDraw              =  'LEGO LDraw (*.ldr)|*.ldr';
  SYNS_FilterURI                =  'URI (*.*)|*.*';
  SYNS_FilterVrml97             =  'Vrml97/X3D (*.wrl;*.wrml;*.vrl;*.vrml;*.x3d)|*.wrl;*.wrml;*.vrl;*.vrml;*.x3d';
  //-----------------------------------------------------
  // Specif to the project Tinn-R project: J.C.Faria
  SYNS_FilterR                  =  'R (*.R; *.r; *.Rhistory; *.site; *.q; *.s; *.ssc)|*.R; *.r; *.Rhistory; *.site; *.q; *.s; *.ssc';
  SYNS_FilterAll                =  'All (*.*)|*.*';
  SYNS_FilterText               =  'Text (*.txt)|*.txt';
  //-----------------------------------------------------
  ...
  SYNS_FriendlyLangGeneralMulti         =  'General_Multi-Highlighter';
  SYNS_FriendlyLangCache                =  'Cache Object Script';
  SYNS_FriendlyLangCSS                  =  'CSS';
