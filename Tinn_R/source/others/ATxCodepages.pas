//
// Codepages info:
// http://msdn2.microsoft.com/en-us/library/ms776446.aspx // Old
// http://msdn.microsoft.com/en-us/library/dd317756.aspx  // J.C.Faria
...
begin
  Result := '';
(* // Commentd by J.C.Faria (it is necessary to Tinn-R project)
