...
uses
  ...
  ComCtrls, RichEdit, StdCtrls, Math, Langs, Classes, IniFiles, XPMenu;
...
begin
  ...
  FMemo:= Memo;
  if not Assigned(FDialog) then FDialog:= TSpellerDialog2.Create(Self);
  Init;
  ContinueCheck;
end;
...
begin
  XPMenuSpell.Active:= frmTinnMain.boolAppearance; //jcfaria
end;
