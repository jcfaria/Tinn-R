...
@lastmod(2013-11-19)
Added comments like HTML to use as a multi/complex R markdown hilighter by Tinn-R..
...
type
  ...
  TRangeState = (rsComment, rsText);  // J.C.Faria
  ...
  private
    ...
    fCommentAttri: TSynHighlighterAttributes;  // J.C.Faria
    fRange: TRangeState;  // J.C.Faria
    ...
    procedure CommentProc;     // J.C.Faria
    procedure BraceCloseProc;  // J.C.Faria
    procedure BraceOpenProc;   // J.C.Faria
  ...
  protected
    ...
    procedure NextProcedure;   // J.C.Faria
  ...
  public
    ...
    function GetRange: Pointer; override;  // J.C.Faria
    function GetTokenID: TtkTokenKind;
    function GetTokenAttribute: TSynHighlighterAttributes; override;
    function GetTokenKind: Integer; override;
    function IsIdentChar(AChar: WideChar): Boolean; override;
    procedure Next; override;
    procedure SetRange(Value: Pointer); override;  // J.C.Faria
    procedure ResetRange; override;  // J.C.Faria
...
procedure TSynURISyn.BraceCloseProc;
begin
  fRange := rsText;
  fTokenId := tkUnknown;
  Inc(Run);
...
procedure TSynURISyn.BraceOpenProc;
begin
  Inc(Run);
...
// J.C.Faria
procedure TSynURISyn.CommentProc;
begin
  fTokenID := tkComment;
...
// J.C.Faria
function TSynURISyn.GetRange: Pointer;
begin
  Result := Pointer(fRange);
end;

// J.C.Faria
procedure TSynURISyn.SetRange(Value: Pointer);
begin
  fRange := TRangeState(Value);
end;

// J.C.Faria
procedure TSynURISyn.ResetRange;
begin
  fRange:= rsText;
end;
...
// J.C.Faria
procedure TSynURISyn.NextProcedure;
begin
  fTokenPos := Run;
  ...
  case fLine[Run] of
    ...
    '<': BraceOpenProc;   // J.C.Faria
    '>': BraceCloseProc;  // J.C.Faria
    else begin
      UnknownProc;
    end;
  end;
