...
type
  TfrmReplace_Confirm_Dlg = class(TForm)
    btnCancel: TButton;
    btnReplace: TButton;
  ...
  public
    ...
    procedure pPrepareShow(AEditorRect: TRect; iX, iY: integer; sReplaceText: string);
  end;

var
  frmReplace_Confirm_Dlg: TfrmReplace_Confirm_Dlg;
...
procedure TfrmReplace_Confirm_Dlg.FormCreate(Sender: TObject);
begin
  Image1.Picture.Icon.Handle:= LoadIcon(0,
                                        IDI_QUESTION);
end;

procedure TfrmReplace_Confirm_Dlg.FormDestroy(Sender: TObject);
begin
  frmReplace_Confirm_Dlg:= nil;
end;

procedure TfrmReplace_Confirm_Dlg.FormShow(Sender: TObject);
begin
...
procedure TfrmReplace_Confirm_Dlg.pPrepareShow(AEditorRect: TRect;
                                                iX,
                                                 iY: integer;
                                                sReplaceText: string);
begin
