...
function TfrmReplace_Dlg.fGetReplaceText: string;
begin
  Result:= cbReplaceText.Text;
end;

function TfrmReplace_Dlg.fGetReplaceTextHistory: string;
var
  i: integer;
...
procedure TfrmReplace_Dlg.pSetReplaceText(sValue: string);
begin
  cbReplaceText.Text:= sValue;
end;

procedure TfrmReplace_Dlg.pSetReplaceTextHistory(sValue: string);
begin
