...
function TfrmSearch_Dlg.GetSearchBackwards: boolean;
begin
  Result:= (rgSearchDirection.ItemIndex = 1);
end;

procedure TfrmSearch_Dlg.SetSearchBackwards(bValue: boolean);
begin
  rgSearchDirection.ItemIndex:= Ord(bValue);
end;

function TfrmSearch_Dlg.GetSearchCaseSensitive: boolean;
begin
  Result:= cbSearchCaseSensitive.Checked;
end;

procedure TfrmSearch_Dlg.SetSearchCaseSensitive(bValue: boolean);
begin
  cbSearchCaseSensitive.Checked:= bValue;
end;

function TfrmSearch_Dlg.GetSearchFromCursor: boolean;
begin
  Result:= (rgSearchOrigin.ItemIndex = 1);
end;

procedure TfrmSearch_Dlg.SetSearchFromCursor(bValue: boolean);
begin
  if bValue then rgSearchOrigin.ItemIndex:= 1
            else rgSearchOrigin.ItemIndex:= 0;
end;

function TfrmSearch_Dlg.GetSearchInSelection: boolean;
begin
  Result:= (rgSearchScope.ItemIndex = 1);
end;

procedure TfrmSearch_Dlg.SetSearchInSelection(bValue: boolean);
begin
  if not bValue then rgSearchScope.ItemIndex:= 0
                else rgSearchScope.ItemIndex:= 1;
end;

function TfrmSearch_Dlg.GetSearchRegularExpression: boolean;
begin
  Result:= cbRegularExpression.Checked;
end;

procedure TfrmSearch_Dlg.SetSearchRegularExpression(const bValue: boolean);
begin
  cbRegularExpression.Checked:= bValue;
end;

function TfrmSearch_Dlg.GetSearchText: string;
begin
  Result:= cbSearchText.Text;
end;

procedure TfrmSearch_Dlg.SetSearchText(sValue: string);
begin
  cbSearchText.Text:= sValue;
end;

function TfrmSearch_Dlg.GetSearchTextHistory: string;
var
  i: integer;
...
procedure TfrmSearch_Dlg.SetSearchTextHistory(sValue: string);
begin
  cbSearchText.Items.Text:= sValue;
end;

function TfrmSearch_Dlg.GetSearchWholeWords: boolean;
begin
  Result:= cbSearchWholeWords.Checked;
end;

procedure TfrmSearch_Dlg.SetSearchWholeWords(bValue: boolean);
begin
