...
procedure TfrmR_Card.edtGroupSearchChange(Sender: TObject);
begin
...
procedure TfrmR_Card.edtFunctionSearchChange(Sender: TObject);
begin
...
procedure TfrmR_Card.FormActivate(Sender: TObject);
begin
...
procedure TfrmR_Card.bbtRcardNewClick(Sender: TObject);
begin
...
procedure TfrmR_Card.bbtRcardDeleteClick(Sender: TObject);
begin
  with modDados.cdRcard do
    Delete;
end;

procedure TfrmR_Card.bbtRcardEditClick(Sender: TObject);
begin
  with modDados.cdRcard do
    Edit;
...
procedure TfrmR_Card.bbtRcardCancelClick(Sender: TObject);
begin
  with modDados.cdRcard do
    Cancel;
  stbRcard.Panels[0].Text:= 'Browse mode';
...
procedure TfrmR_Card.bbtRcardSaveClick(Sender: TObject);
begin
...
procedure TfrmR_Card.pActualize_Groups;
begin
...
procedure TfrmR_Card.FormClose(Sender: TObject;
...
procedure TfrmR_Card.FormCloseQuery(Sender: TObject;
...
procedure TfrmR_Card.FormShow(Sender: TObject);
begin
  AlphaBlendValue:= frmMain.iAlphaBlendValue;
end;

procedure TfrmR_Card.bbtRcardCloseClick(Sender: TObject);
begin
  with modDados.cdRcard do begin
...
procedure TfrmR_Card.dbgRcardTitleClick(Column: TColumn);
begin
  with modDados.cdRcard do
...
procedure TfrmR_Card.bbHelpClick(Sender: TObject);
begin
  frmMain.pOpen_UserGuidePDF('"Card (R)"');
end;

procedure TfrmR_Card.bbtRcardCancelAllClick(Sender: TObject);
begin
  with modDados.cdRcard do
    SavePoint:= frmMain.iRcard_SavePoint;
end;
