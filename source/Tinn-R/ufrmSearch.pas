...
function TfrmSearchDlg.fGetSearchBackwards: boolean;
begin
  Result:= (rgSearchDirection.ItemIndex = 1);
end;

procedure TfrmSearchDlg.pSetSearchBackwards(bValue: boolean);
begin
  rgSearchDirection.ItemIndex:= Ord(bValue);
end;

function TfrmSearchDlg.fGetSearchCaseSensitive: boolean;
begin
  Result:= cbSearchCaseSensitive.Checked;
end;

procedure TfrmSearchDlg.pSetSearchCaseSensitive(bValue: boolean);
begin
  cbSearchCaseSensitive.Checked:= bValue;
end;

function TfrmSearchDlg.fGetSearchFromCursor: boolean;
begin
  Result:= (rgSearchOrigin.ItemIndex = 1);
end;

procedure TfrmSearchDlg.pSetSearchFromCursor(bValue: boolean);
begin
  if bValue then rgSearchOrigin.ItemIndex:= 1
            else rgSearchOrigin.ItemIndex:= 0;
end;

function TfrmSearchDlg.fGetSearchInSelection: boolean;
begin
  Result:= (rgSearchScope.ItemIndex = 1);
end;

procedure TfrmSearchDlg.pSetSearchInSelection(bValue: boolean);
begin
  if not bValue then rgSearchScope.ItemIndex:= 0
                else rgSearchScope.ItemIndex:= 1;
end;

function TfrmSearchDlg.fGetSearchRegularExpression: boolean;
begin
  Result:= cbRegularExpression.Checked;
end;

procedure TfrmSearchDlg.pSetSearchRegularExpression(const bValue: boolean);
begin
  cbRegularExpression.Checked:= bValue;
end;

function TfrmSearchDlg.fGetSearchText: string;
begin
  Result:= cbSearchText.Text;
end;

procedure TfrmSearchDlg.pSetSearchText(sValue: string);
begin
  cbSearchText.Text:= sValue;
end;

function TfrmSearchDlg.fGetSearchTextHistory: string;
var
  i: integer;
...
procedure TfrmSearchDlg.pSetSearchTextHistory(sValue: string);
begin
  cbSearchText.Items.Text:= sValue;
end;

function TfrmSearchDlg.fGetSearchWholeWords: boolean;
begin
  Result:= cbSearchWholeWords.Checked;
end;

procedure TfrmSearchDlg.pSetSearchWholeWords(bValue: boolean);
begin
...
procedure TfrmSearchDlg.rgSearchScopeClick(Sender: TObject);
begin
